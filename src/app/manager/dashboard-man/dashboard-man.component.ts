...
export class DashboardManComponent {
  details: any[] = [];
  filteredDetails = [...this.details]; // Initialize with all tickets
  filterForm!: FormGroup;
  feedbackForm!: FormGroup;
  selectedSortOption: string = 'start_date'; // Default sort option
  ...
  filterByEmployeeName(searchTerm: string): void {
    if (!searchTerm.trim()) {
        this.filteredDetails = [...this.details]; // Show all tickets if search term is empty
        return;
    }
